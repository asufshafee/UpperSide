...
import com.app.upperside.content.ContentItem;
...
public class Detail_Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("UpperSide");
...
//        vp.setAdapter(mPagerAdapter);
    ...
    private final PagerAdapter mPagerAdapter = new PagerAdapter() {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (mInflater == null) {
                mInflater = LayoutInflater.from(Detail_Activity.this);
            }
    ...
    private void setShareIntent(int position) {
        ...
        if (mShareActionProvider != null) {
            ...
            Intent shareIntent = item.getShareIntent(Detail_Activity.this);
